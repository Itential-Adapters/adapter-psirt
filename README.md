...
<table border="1" class="bordered-table">
  ...
  <tr>
    ...
    <td style="padding:15px">Required for validation of adapter properties to integrate with Psirt.</td>
  </tr>
  <tr>
...
or
unzip adapter-psirt.zip
or
tar -xvf adapter-psirt.tar
```
...
<table border="1" class="bordered-table">
  ...
  <tr>
    ...
    <td style="padding:15px">Provides a connectivity check to the Psirt system.</td>
  </tr>
  <tr>
    <td style="padding:15px">npm run healthcheck</td>
    <td style="padding:15px">Checks whether the configured healthcheck call works to Psirt.</td>
  </tr>
  <tr>
    <td style="padding:15px">npm run basicget</td>
    <td style="padding:15px">Checks whether the basic get calls works to Psirt.</td>
  </tr>
</table>
<br>
