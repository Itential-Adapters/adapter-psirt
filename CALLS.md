...
<table border="1" class="bordered-table">
  ...
  <tr>
    ...
    <td style="padding:15px">This call ensures that the adapter can communicate with Psirt. The actual call that is used is defined in the adapter properties and .system entities action.json file.</td>
    <td style="padding:15px">No</td>
  </tr>
  <tr>
