...
3. Verify there is connectivity between the Itential Platform Server and Psirt Server.
...
4. Verify the credentials provided for Psirt.

```text
login to Psirt using the provided credentials
```

5. Verify the API of the call utilized for Psirt Healthcheck.
